...
# Formats ffmpeg can read (demuxers)
FROM_FORMATS = {
    "264",
    "265",
    "266",
...
# Formats ffmpeg can write (muxers)
TO_FORMATS = {
    "264",
    "265",
    "266",
...
async def trim(input_path: Path, output_path: Path, start: str, end: str) -> Path:
    """Frame/sample-accurate trim via re-encode. Picks video or audio codec path
    based on the input's extension."""
    ...
    if ext in AUDIO_EXTENSIONS:
        args = [
            ...
            "-c:a",
            "libmp3lame" if output_path.suffix == ".mp3" else "aac",
            str(output_path),
        ]
    else:
        args = [
